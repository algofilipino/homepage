      ...
      <div>
        <div className="grid grid-flow-row auto-rows-max md:auto-rows-min mt-36 ">
          <div className="grid grid-flow-col auto-cols-full">
            <h3 className="text-h2 font-josefin leading-none flex items-end pb-10 pr-10 self-center">
              Learn <br /> Build <br /> Innovate
            </h3>
            <div className="grid grid-flow-row auto-rows-max md:auto-rows-min">
              <img src={bodyImage1} />
              <p className="text-justify py-10 text-p">
                Ang Algo Filipino ay itinatag ni John Jherlet Hollero noong
                Setyembre 27, 2020 sa edad na labing - siyam na taong gulang.
                Ito ay nagsimula sa ideya ng pagkakaroon ng kolaborasyon ng mga
          ...
          <div className="grid grid-flow-col auto-cols-full">
            <div className="grid grid-flow-row auto-rows-max md:auto-rows-min">
              ...
              <p className="text-justify py-10 text-p">
                ...
                binubuo ng mga kabataan na iisa ang adhikain pagdating sa Wika
                at Teknolohiya. Tinawag itong “Tambayan” dahil gustong iparating
                ng Algo Filipino sa manonood at madla na magaan lamang ang hatid
                ng programa at maari sila manood dito pagkatapos ng isang
                nakakapagod na maghapon.
              </p>
            </div>
            <h2 className="text-h2 font-josefin leading-none flex items-end pb-10 pl-10 self-center">
